...
class PhishingDetectorUI(tk.Toplevel):
    ...
    def __init__(self, master):
        ...
        title_label = tk.Label(header_frame, text="ML Phishing Analyzer", font=self.title_font, bg=WINDOW_BG, fg=TEXT_COLOR)
        ...
        try:
            ...
            print("logo.jpg not found for Phishing Detector.")
        # --- End Header ---
