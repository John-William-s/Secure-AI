...
class FileEncryptorUI(tk.Toplevel):
    ...
    def __init__(self, master):
        ...
        title_label = tk.Label(header_frame, text="File Encryptor / Decryptor", font=self.title_font, bg=WINDOW_BG, fg=TEXT_COLOR)
        ...
        try:
            ...
            print("logo.jpg not found for File Encryptor.")
        # --- End Header ---
